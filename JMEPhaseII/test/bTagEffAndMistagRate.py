...
# input files
inputFile_ttbar = TFile.Open('hbtagdiscriminators_ttbar1.root')
...
discrVsPt_b_QCD      = inputFile_ttbar.Get('bTaggingExerciseII/' + bTagger + '_2b')
discrVsPt_udsg_QCD   = inputFile_ttbar.Get('bTaggingExerciseII/' + bTagger + '_2udsg')
...
eff_b_ttbar.GetXaxis().SetRangeUser(0.,400.)
eff_b_ttbar.GetYaxis().SetRangeUser(0.,1.)
eff_b_ttbar.SetLineWidth(2)
eff_b_ttbar.SetLineColor(kBlack)
eff_b_ttbar.SetMarkerColor(kBlack)
eff_b_ttbar.SetMarkerStyle(20)
eff_b_ttbar.Draw('ap')

eff_b_QCD = TGraphAsymmErrors(tagged_b_QCD, total_b_QCD, "cp")
eff_b_QCD.SetLineWidth(2)
eff_b_QCD.SetLineColor(kBlue)
eff_b_QCD.SetMarkerColor(kBlue)
eff_b_QCD.SetMarkerStyle(21)
eff_b_QCD.Draw('p')

legend = TLegend(.50,.30,.90,.40)
legend.SetBorderSize(0)
legend.SetFillColor(0)
legend.SetFillStyle(0)
legend.SetTextFont(42)
legend.SetTextSize(0.04)
legend.AddEntry(eff_b_ttbar,"b-jet 0 < |#eta| < 1.5","lp")
legend.AddEntry(eff_b_QCD,"b-jet 1.5 < |#eta| < 2.5","lp")
legend.Draw()
