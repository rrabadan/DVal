...
options.register('outputFilename', 'hbtagdiscriminators.root',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "Output file name"
)
options.register('process', 'ttbar1',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        '/store/relval/CMSSW_8_1_0_pre12/RelValTTbar_14TeV/MINIAODSIM/81X_mcRun2_asymptotic_v8_2023D1-v1/00000/54432A6E-1483-E611-A491-0CC47A78A456.root',
        '/store/relval/CMSSW_8_1_0_pre12/RelValTTbar_14TeV/MINIAODSIM/81X_mcRun2_asymptotic_v8_2023D1-v1/00000/B4788866-1483-E611-BC31-0CC47A7C3432.root'
    )
)

if options.process == "ttbar2":
